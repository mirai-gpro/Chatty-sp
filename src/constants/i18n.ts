...
export const i18n = {
  ...
  en: {
    ...
    initialGreetingLesson: 'Hello! I\'m Chatty AI. Your chat buddy and companion.',
  ...
  zh: {
    ...
    initialGreetingLesson: '您好！我是Chatty AI。您的聊天伙伴和倾诉对象。',
  ...
  ko: {
    ...
    initialGreetingLesson: '안녕하세요! Chatty AI입니다. 당신의 대화 친구이자 동반자입니다.',
